    ...
    return (
        <div className="selfInfo-card">
            <span className="info-name">
                ...
                <input className = "info-content" disabled={!modify} value = {name} onChange={(e)=>setName(e.target.value)}/>
            </span>
            ...
            <div className = "info-slogan">
                ...
                <textarea className = "slogan-text" disabled = {!modify} value = {notes} onChange = {(e)=>{setNotes(e.target.value)}}placeholder= "请输入个人签名"></textarea>
            </div>
